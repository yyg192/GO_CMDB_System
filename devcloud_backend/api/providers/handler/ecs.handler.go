...
// type EcsHandler interface {
// 	M_GetEcsInfoGroup(req *QueryEcsGroupRequest)                              //从云商获取一定数量的Ecs主机实例，这个数量就是一个page的大小
// 	M_GetEcsInfoDetailOne(ctx context.Context, req *QueryEcsDetailOneRequest) //从云商获取一个Ecs主机实例的详细信息
// }
